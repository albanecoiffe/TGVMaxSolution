...
PAGES = {
    "direct": {
        ...
        "hero_title": "Voir rapidement tous les trains MAX a 0 EUR sur une page dediee.",
        "hero_text": "Cette vue est faite pour partir vite: un depart, une date, une carte et la liste cliquable des trajets vers SNCF Connect.",
        "map_help": "Destinations directes disponibles a 0 EUR depuis le point de depart.",
        "result_title": "Trains a 0 EUR du jour",
        "result_help": "Clique un train pour l'ouvrir sur SNCF Connect.",
